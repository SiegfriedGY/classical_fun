...
@Data
@Slf4j
@Table(name="music_piece_real")
@Entity
@JsonIgnoreProperties(value={"hibernateLazyInitializer","handler","fieldHandler"})
public class MusicPieceReal {
    ...
    private Integer composer_name_fake01;
    private Integer composer_name_fake02;
    private Integer composer_name_fake03;
    /// 需要提供混淆项
